...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    aButton.toggleOnTrue(new SimpleMotorControl(motor1));
    xButton.toggleOnTrue(new SimpleMotorControl(motor2));
    bButton.toggleOnTrue(new SimpleMotorControl(motor3));
  }
